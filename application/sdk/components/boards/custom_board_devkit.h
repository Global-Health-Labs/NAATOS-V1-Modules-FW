...
#define PIN_I2S_LRCLK        MAP(0,  6) // "23 D11  LED1_G",               23  22  D11  L1   P0.06 -             D11
#define PIN_FEATHER_D6       MAP(0,  7) // "20 D6   PWM_OUTPUT_PIN_1",     20  23  D6   M2   P0.07 -  TRACECLK   Trace clk Trace clock
#define PIN_I2S_WCLK         MAP(0,  8) // "24 D12  LED2_R",               24  24  D12  N1   P0.08 -             D12
#define PIN_NFC1             MAP(0,  9) // " -  -   PIN_NFC1",              -   -   -   L24  P0.09 -  NFC1       NFC antenna
#define PIN_NFC2             MAP(0, 10) // " -  -   PIN_NFC2",              -   -   -   J24  P0.10 -  NFC2       NFC antenna
#define PIN_I2C_SCL          MAP(0, 11) // "18 SCL  -",                    18  27  SCL  T2   P0.11 -  TRACEDATA2 Trace 2           SCL
#define PIN_I2C_SDA          MAP(0, 12) // "17 SDA  LED2_B",               17  29  SDA  U1   P0.12 -  TRACEDATA1 Trace 1
...
#define PIN_QSPI_MOSI        MAP(0, 17) // " - Q0   PIN_QSPI_FLASH_IO0",    -  41  Q0   AD12 P0.17 -             QSPI D0  GD25Q16 16MBit FLASH
#define PIN_NRESET           MAP(0, 18) // " 1  -   PIN_NRESET",            1  40   -   AC13 P0.18 -  nRESET     nRESET
#define PIN_QSPI_CLK         MAP(0, 19) // " = QC   PIN_QSPI_FLASH_SCK",    =  42  QC   AC15 P0.19 -             QSPI SCK GD25Q16 16MBit FLASH
#define PIN_QSPI_CS          MAP(0, 20) // " - QCS  PIN_QSPI_FLASH_CSN",    -  44  QCS  AD16 P0.20 -             QSPI CS  GD25Q16 16MBit FLASH
#define PIN_QSPI_IO3         MAP(0, 21) // " - Q3   PIN_QSPI_FLASH_IO3",    -  43  Q3   AC17 P0.21 -             QSPI D3  GD25Q16 16MBit FLASH
#define PIN_QSPI_MISO        MAP(0, 22) // " - Q1   PIN_QSPI_FLASH_IO1",    -  46  Q1   AD18 P0.22 -             QSPI D1  GD25Q16 16MBit FLASH
#define PIN_QSPI_IO2         MAP(0, 23) // " - Q2   PIN_QSPI_FLASH_IO2",    -  45  Q2   AC19 P0.23 -             QSPI D2  GD25Q16 16MBit FLASH
...
#define PIN_AUDIO_RESET_N    MAP(0, 26) // "21 D9   PWM_OUTPUT_PIN_0",     21  19  D9   G1   P0.26 -
#define PIN_I2S_DIN          MAP(0, 27) // "22 D10  -",                    22  16  D10  H2   P0.27 -
...
#define PIN_I2S_BCLK         MAP(1,  9) // "25 D13  ",                     52  R1   25  D13  P1.09 -  TRACEDATA3 Trace 3
...
#define BUTTONS_LIST { PIN_SWITCH }

#define BSP_BUTTON_0 PIN_SWITCH

#define LEDS_ACTIVE_STATE 0

#define LEDS_LIST { PIN_LED1_RED, PIN_LED2_BLUE }
