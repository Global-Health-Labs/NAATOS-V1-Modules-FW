...
const char *sp_default_cycle_config_1 = 
  ...
  "motor_ki:0.0005\n"
  "motor_kd:0.020";
const int sp_default_cycle_config_1_size = 288;
...
const char *sp_default_cycle_config_2 = 
  ...
  "motor_ki:0.0005\n"
  "motor_kd:0.020";
const int sp_default_cycle_config_2_size = 288;
...
const char *sp_default_cycle_config_3 = 
  ...
  "motor_ki:0.0005\n"
  "motor_kd:0.020";
const int sp_default_cycle_config_3_size = 288;
...
const char *sp_default_cycle_config_4 = 
  ...
  "motor_ki:0.0005\n"
  "motor_kd:0.020";
  const int sp_default_cycle_config_4_size = 287;
